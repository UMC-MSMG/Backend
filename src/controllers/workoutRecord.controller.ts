...
export class WorkoutRecordController {
  static async createThreeDayWorkout(req: Request, res: Response) {
    /*
    #swagger.tags = ['Workout']
    #swagger.summary = '[운동 스케줄 생성] 3일치 운동 기록 생성'
    #swagger.description = '오늘부터 3일 동안 하루에 해야하는 운동 기록을 생성합니다. 이미 존재하는 경우 생성하지 않습니다.'
...
*/
    ...
    try {
      ...
      const result = await workoutRecordService.generateThreeDayWorkout(userId);
